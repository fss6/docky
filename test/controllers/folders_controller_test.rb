...
class FoldersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create folder" do
    assert_difference("Folder.count") do
      post folders_url, params: { folder: { account_id: @folder.account_id, name: @folder.name } }
    end
  ...
  test "should update folder" do
    patch folder_url(@folder), params: { folder: { account_id: @folder.account_id, name: @folder.name } }
